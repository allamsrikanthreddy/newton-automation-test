...
public class MyPreferrencePage extends DesktopBasePage {
	...
	public void verifysuggestionPriorities(Hashtable<String, String> data) {
		...
		//}else {
			...
			//Option 1
			if((!data.get("Coverage on Priority 1 O1").equals("")) || (!data.get("Coverage on Priority 1 O2").equals("0"))) {
			...
			//Option2
			if((!data.get("Coverage on Priority 1 O2").equals("")) || (!data.get("Coverage on Priority 1 O2").equals("0"))) {
				...
				verifyText(p2o2.getText().replace("COVERAGE: $", "").replace(",", ""), data.get("Coverage on Priority 1 O2"), "Verify Option 2 Priority 1 --  Expected:: "+data.get("Coverage on Priority 1 O2")+" Actual:: "+p2o2.getText());
				
			}
			
			if((!data.get("Coverage on Priority 2 O2").equals("")) || (!data.get("Coverage on Priority 2 O2").equals("0"))) {
				...
				verifyText(p2o2.getText().replace("COVERAGE: $", "").replace(",", ""), data.get("Coverage on Priority 2 O1"), "Verify Option 2 Priority 2 --  Expected:: "+data.get("Coverage on Priority 2 O1")+" Actual:: "+p2o2.getText());
			}
			
			if((!data.get("Coverage on Priority 3 O2").equals("")) || (!data.get("Coverage on Priority 3 O2").equals("0"))) {
				...
				verifyText(p3o2.getText().replace("COVERAGE: $", "").replace(",", ""), data.get("Coverage on Priority 3 O2"), "Verify Option 2 Priority 3 --  Expected:: "+data.get("Coverage on Priority 3 O2")+" Actual:: "+p3o2.getText());
			}
			
			//Option 3		
			if((!data.get("Coverage on Priority 1 O3").equals("")) || (!data.get("Coverage on Priority 1 O3").equals("0"))) {
				...
				verifyText(p2o3.getText().replace("COVERAGE: $", "").replace(",", ""), data.get("Coverage on Priority 1 O3"), "Verify Option 3 Priority 1 --  Expected:: "+data.get("Coverage on Priority 1 O3")+" Actual:: "+p2o3.getText());
			}
			
			if((!data.get("Coverage on Priority 2 O3").equals("")) || (!data.get("Coverage on Priority 2 O3").equals("0"))) {
				...
				verifyText(p2o3.getText().replace("COVERAGE: $", "").replace(",", ""), data.get("Coverage on Priority 2 O3"), "Verify Option 3 Priority 2 --  Expected:: "+data.get("Coverage on Priority 2 O3")+" Actual:: "+p2o3.getText());
			}
			
			if((!data.get("Coverage on Priority 3 O3").equals("")) || (!data.get("Coverage on Priority 3 O3").equals("0"))) {
				...
				verifyText(p3o3.getText().replace("COVERAGE: $", "").replace(",", ""), data.get("Coverage on Priority 3 O3"), "Verify Option 3 Priority 3 --  Expected:: "+data.get("Coverage on Priority 3 O3")+" Actual:: "+p3o3.getText());
			}
		//}
